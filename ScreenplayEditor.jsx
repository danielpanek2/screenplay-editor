        ...
        <div style={styles.pageWrap}>
          <div style={styles.page} className="print-page">
            {buildPageGroups(blocks).map((g, idx) => {
              const gap = idx === 0 ? undefined : "12pt";
              if (g.kind === "single") {
                return (
                  <div key={g.block.id} style={{ marginTop: gap }}>
                    {renderField(g.block)}
                  </div>
                );
              }
              if (g.kind === "cue") {
                return (
                  <div key={g.character.id} style={{ marginTop: gap }}>
              ...
              return (
                <div key={g.left.character.id} style={{ ...styles.dualRow, marginTop: gap }}>
